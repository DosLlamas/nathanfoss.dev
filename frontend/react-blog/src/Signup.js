      ...
      <div className="welcome-card">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex flex-col items-center ">
            ...
            <EmailIcon sx={{ color:"#c4c7c5", fontSize: "50px", marginTop:"200%" }} />
            <LockIcon sx={{ color:"#c4c7c5", fontSize: "50px", marginTop:"40%" }} />
          </div>
        ...
        <div className="contact-card-wrapper" style={{ cursor: "pointer" }}>
          ...
          <div className="contact-card"><LoginIcon /> Sign up</div>
        </div>
      </div>
    </div>
  );
